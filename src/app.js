...
import './App.css';
import logo from './images/desktop/image-header-rbg.png';
import egg from './images/desktop/image-transform.jpg';
import slogo from './images/desktop/image-stand-out.jpg';
  ...
  return (
    <div className="container">
        <div className="home_pg">
          <div className="hd-lg"><h2>SunnySide</h2></div>
          <nav>
            <ul>
              <li className="menu"><a href="#" name="about">About</a></li>
              <li className="menu"><a href="#">Services</a></li>
              <li className="menu"><a href="#">Projects</a></li>
              <li className="menu"><a href="#">Contact</a></li>
            </ul>
          </nav>
          <h1 id='heading'>We are CreativSes</h1>
            <div className="headlogo">
              <img src={logo} id="hlogo" alt="logo" />   
            </div>    
        </div>
        ...
        <div className="about-pg">
            <div className="des-pg">
              ...
              <div className=" box ">
                <img src={egg} alt="image-transform" />
              </div>
            </div>
            
            <div className="des-pg">
              <div className=" box">
                <img src={slogo} alt="image-transform" />
              </div>
              <div className=" box box1">
              <h1>Stand out to the right audience </h1>
                <div className="bx-para">
                  <p>Using a collaborative formula of designer, researchers, photographers, videographers, and copywriteres, we'll build and extend your brand in digital places.</p>
                </div>
              </div>
            </div>
            ...
            <div className="des-pg">
              <div className=" box box2" >
                <div className="img-dsg">
                  <img src={graphic} alt="graphic-logo" />
                </div>
                <div className="img-ds">
                  <h2>Graphic Design </h2>
                  <div className="bx-para">
                    <p>Great design makes you memorable. We deliver artwork that underscores your brand message and captures potentials client's attention.</p>
                  </div>
                </div>
              </div>
              <div className="box box2">
        ...
        <h2 id='client-head'>Client Testimonails</h2>
        <div className="client-pg">
          <div className="client">
            <img src={emily} alt="emily-img" />
            <p>We put our trust in Sunnyside and they delivered making sure our needs were met and deadlines were always hit</p>
            <div className="prof-pst">
              <span className="name">Emily.R</span> 
              <span className="designation">Marketing Director</span>
            </div>
          </div>
          <div className="client">
            <img src={thomas} alt="thomas-img" />
            <p>Sunnyside's enthusiasm coupled with thier keen interest in our brand's success made it a satishfying and enjoyable experience.</p>
            <div className="prof-pst">
              <span className="name">Thomas.S</span> 
              <span className="designation">cheif Opperating Officer</span>
            </div>
          </div>
          <div className="client">
            <img src={jennie} alt="jennie-img" /> 
        ...
        <div className="img-vw">
          <div className="img-logo">
            <img src={bottles} alt="logo" />
          </div>
          <div className="img-logo">
        ...
        <footer>
          ...
          <div className="soc-links">
            <div className="s-logo">
              <svg width="20" height="20" xmlns="http://www.w3.org/2000/svg" id="s-logo" title="facebook" >
                <path d="M18.896 0H1.104C.494 0 0 .494 0 1.104v17.793C0 19.506.494 20 1.104 20h9.58v-7.745H8.076V9.237h2.606V7.01c0-2.583 1.578-3.99 3.883-3.99 1.104 0 2.052.082 2.329.119v2.7h-1.598c-1.254 0-1.496.597-1.496 1.47v1.928h2.989l-.39 3.018h-2.6V20h5.098c.608 0 1.102-.494 1.102-1.104V1.104C20 .494 19.506 0 18.896 0z" fill="#2C7566" fill-rule="nonzero"/>
              </svg>
            </div>
            <div className="s-logo">
              <svg width="20" height="20" xmlns="http://www.w3.org/2000/svg" id="s-logo" name="facebook">
            ...
            <div className="s-logo">
              <svg width="20" height="17" xmlns="http://www.w3.org/2000/svg" id="s-logo" name="facebook">
